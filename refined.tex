...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \end{align*}
    as desired.
    \item $(\qsp{\Gamma, x : A}{\mb{q}, q}{\mb{q}_l, 0}{\mb{q}_r, q})$:  
    \TODO{right strike}
    \item $(\qsp{\Gamma, x : A}{\mb{q}, q}{\mb{q}_l, q}{\mb{q}_r, q})$:  
    \TODO{split strike}
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item $(\hasty{\Gamma^{\mb{q}}}{}{\linl{a}}{A + B}):$ \todo{:(}
    \item $(\hasty{\Gamma^{\mb{q}}}{}{\linr{b}}{A + B})$: \todo{:(}
