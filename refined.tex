...
We can now give the typing rules for \subiterssa{} in Figure~\ref{fig:subiterssa-typing}.

\TODO{explain: variables}

\TODO{explain: applications}

\TODO{explain: pairs}

\TODO{explain: let-bindings}

\TODO{explain: injections, cases, and aborts}
