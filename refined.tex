...
We now verify that:
\begin{itemize}
  \item We begin by verifying that $\ms{Tm}_\epsilon(\mc{R})$ is indeed a category: we have that,
  ...
  \item $\ms{Tm}(\mc{R})$ is an Elgot category: 
  We begin by briefly noting the following useful fact:
  \begin{proposition}
