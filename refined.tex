...
call-by-push-value~\cite{cpbv}, and then use the normal form
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{align*}
      ...
      \\
      &= (\lambda (((x_1, x_2), x_3), x_4) . 
        \letexpr{((y_1, y_{23}), y_4)}{((x_1, (x_2, x_3)), x_4)}{(y_1, (y_{23}, y_4))}) ; \\ & \qquad 
      (\lambda (z_1, ((z_2, z_3), z_4)) . (z_1, (z_2, (z_3, z_4))))
      \\
      &= (\lambda (((x_1, x_2), x_3), x_4) . ((x_1, (x_2, x_3)), x_4)) ; 
    ...
    \end{align*}
    \item Triangle equations (\cmark): we have that
      \begin{align*}
      ...
      \end{align*}
    \item Hexagon equation: \todo{this...}
  \end{itemize}
  ...
  \item $\ms{Tm}(\mc{R})$ has an iteration operator: \todo{this...}
  \item $\ms{Tm}(\mc{R})$ is an Elgot category: it suffices to show that our iteration operator
  satisfies:
  \begin{itemize}
    \item Naturality: \todo{this}
    \item Codiagonal: \todo{this}
    \item Directed Uniformity: \todo{this}
    \item Dinaturality:
    We have that:
    \begin{proposition}
