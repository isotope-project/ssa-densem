...
\begin{itemize}
  ...
  \end{gather*}
  \item $\ms{Tm}_\epsilon(\mc{R})$ has symmetric premonoidal structure $(\mb{1}, \otimes, \alpha,
  \lambda, \rho, \sigma)$: \todo{this...}
  \item $\ms{Tm}(\mc{R})$ has chosen coproudcts and initial object $(\mb{0}, +, \iota_l, \iota_r,
  [\cdot, \cdot])$ (\cmark):
  \todo{this...}
