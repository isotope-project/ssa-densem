...
\TODO{we can use this to validate a few of the usual rewrite rules for heapcraft}

\TODO{by power of nondeterminism, allocations are central}

\TODO{can therefore implement mem2reg, see the appendix}

\TODO{separation logic pointer for Moar Commutativity}
