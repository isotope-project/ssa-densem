...
We can now proceed to give a denotational semantics for \isotopessa{}, which we will then use to 
relate it to \subiterexp{}. We begin by giving a denotational semantics for label contexts and label
