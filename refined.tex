...
Appendix~\ref{apx:ssa-roundtrip}.
...
\prftree[r]{\rle{let-ssa}}
  {\qsp{\Gamma}{\mb{q}}{\mb{q}_l}{\mb{q}_r}}
  {\hasty{\Gamma^{\mb{q}_r}}{\epsilon}{a}{A}}
  {\haslb{\Gamma^{\mb{q}_l}, x : A}{\epsilon}{s}{\ms{L}}}
  {\haslb{\Gamma^{\mb{q}}}{\epsilon}{\ssalet{x}{a}{s}}{\ms{L}}}
$$
and has the expected semantics
$$
\dnt{\haslb{\Gamma^{\mb{q}}}{\epsilon}{\ssalet{x}{a}{s}}{\ms{L}}} =
  \dnt{\qsp{\Gamma}{\mb{q}}{\mb{q}_l}{\mb{q}_r}} 
  ; \dnt{\Gamma^{\mb{q}_l}} \otimes \dnt{\hasty{\Gamma^{\mb{q}_r}}{\epsilon}{a}{A}} 
  ; \dnt{\haslb{\Gamma^{\mb{q}_l}, x : A}{\epsilon}{s}{\ms{L}}}
$$
...
\begin{align*}
  ...
  ; \dnt{\haslb{\Gamma^{\mb{0}}, x : A}{\epsilon}{\brb{\ell}{x}}{\ell(A)^0}} \\
  &= \dnt{\hasty{\Gamma^{\mb{q}}}{\epsilon}{a}{A}} ; \alpha
  ; \dnt{\qsp{\Gamma, x : A}{\mb{0}, \omega}{\mb{0}, 0}{\mb{0}, \omega}}
...
\begin{itemize}
  ...
  \item (Let-bindings $\letexpr{x}{a}{b}$): \todo{on}
  \item (Binary let-bindings $\letexpr{(x, y)}{a}{b}$): \todo{the}
  \item (Pairs $(a, b)$): \todo{clock}
  \item (Case-statements $\caseexpr{e}{x}{a}{y}{b}$): \todo{it never stops?}
