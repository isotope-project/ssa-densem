...
\begin{proof}
  ...
  \begin{itemize}
    \item $(\hasty{\Gamma^{\mb{q}}}{}{x}{A})$:
    \item $(\hasty{\Gamma^{\mb{q}}}{}{\letexpr{x}{a}{b}}{B})$:
    \item $(\hasty{\Gamma^{\mb{q}}}{}{()}{\mb{1}})$:
    \item $(\hasty{\Gamma^{\mb{q}}}{}{(a, b)}{A \otimes B})$:
    \item $(\hasty{\Gamma^{\mb{q}}}{}{\letexpr{(x, y)}{a}{c}}{C})$:
    \item $(\hasty{\Gamma^{\mb{q}}}{}{\caseexpr{e}{x}{a}{y}{b}}{C})$:
    \item $(\hasty{\Gamma^{\mb{q}}}{}{\labort{a}}{A})$:
    \item $(\hasty{\Gamma^{\mb{q}}}{}{\liter{a}{x}{b}}{B})$:
  \end{itemize}
\end{proof}
