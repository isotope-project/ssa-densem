...
\begin{itemize}
  ...
  \ell_r(A)^{\mb{q}_{12}, 0}, \ell_h(A + B)^{\mb{q}_{12}, 0}, \ell_o(B)^{\mb{q}_{12}, 0}$:
  \begin{align*}
  & \dnt{
  ...
  &= \dnt{\qsp{\Gamma}{\mb{q}}{\mb{q}_{12}}{\mb{q}_3}}
      ...
      \delta^{-1} ; [\iota_r ; \iota_r, \iota_l ; \iota_l ; \iota_r], \\ & \qquad
      \dnt{\haslb{\Gamma^{\mb{q}_{12}}, x : B}{\epsilon}
        {\tossa{\ell}{Q}}
        {
          \ell(C)^{\mb{q}_1, 0}, 
  ...
  &= \dnt{\qsp{\Gamma}{\mb{q}}{\mb{q}_{12}}{\mb{q}_3}}
      ...
      } ; \alpha^\downarrow ; \alpha^+, \text{\todo{unfold}} \\ & \qquad
      \delta^{-1} ; [\iota_r ; \iota_r, \iota_l ; \iota_l ; \iota_r], \\ & \qquad
      \dnt{\haslb{\Gamma^{\mb{q}_{12}}, x : B}{\epsilon}
        {\tossa{\ell}{Q}}
        {
      ...
      } ; \alpha^\downarrow ; \alpha^+ \text{\todo{unfold}}
    ]^\dagger \\
  \end{align*}
  \TODO{DROPL}
\end{itemize}
