...
\TODO{define $\ms{Tm}(\mc{R})$; the syntactic model}

\TODO{ can make $\ms{Tm}(\mc{R})$ into a \subiterexp{}-model; do we put this part into the appendix?
  probably not since we need it for SSA }

\TODO{this allows us to prove completeness as follows:}
