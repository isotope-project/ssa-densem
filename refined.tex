...
\newcommand{\csubst}[5]{#1 \vdash_{#4}^{#5} #2 : #3}
...
\newcommand{\subdistssa}{\(\lambda_{\leq\otimes+}\)}
\newcommand{\subiterssa}{\(\lambda_{\leq\otimes+}^\dagger\)}
\newcommand{\isotopessa}{\(\lambda_{\ms{SSA}}\)}
\newcommand{\thsubmon}[1]{\ms{Th}_{\leq\otimes}(#1)}
\newcommand{\thsubdist}[1]{\ms{Th}_{\leq\otimes+}(#1)}
\newcommand{\thsubiter}[1]{\ms{Th}_{\leq\otimes+}^\dagger(#1)}
...
\begin{grammar}
  ...
  <\(q\)> ::= \(\bot\) | \(\zeroq\) | \(\oneq\) | \(\cpyq\) | \(\delq\) | \(\topq\)
...
\begin{gather*}
  \prftree[r]{\rle{var}}
    {\cwk{\Gamma^{\mb{q}}_{\mb{e}}}{x : A^\oneq_\epsilon}}{\hasty{\Gamma}{\epsilon}{x}{A}} 
    \qquad
  ...
  \prftree[r]{\rle{unit}}
    {\cwk{\Gamma^{\mb{q}}_{\mb{e}}}{\cdot}}{\hasty{\Gamma;\vec{q}}{}{()}{\mb{1}}} 
    \qquad
...
% \begin{gather*}
%   \prftree[r]{\rle{nil}}
%     {\qwk{\cdot}{\cdot}{\cdot}{\cdot}} \qquad
%   \prftree[r]{\rle{cons}}
%     {\qwk{\Gamma}{\mb{q}}{\mb{q}_l}{\mb{q}_r}}
%     {\cpyq \leq q \sqcap \alquant(A)}
%     {\qwk{\Gamma, x : A}{(\mb{q}, q)}{(\mb{q}_l, q)}{(\mb{q}_r, q)}}
%     \\
%   \prftree[r]{\rle{left}}
%     {\qwk{\Gamma}{\mb{q}}{\mb{q}_l}{\mb{q}_r}}
%     {\qwk{\Gamma, x : A}{(\mb{q}, q)}{(\mb{q}_l, q)}{(\mb{q}_r, \zeroq)}} \qquad
%   \prftree[r]{\rle{right}}
%     {\qwk{\Gamma}{\mb{q}}{\mb{q}_l}{\mb{q}_r}}
%     {\qwk{\Gamma, x : A}{(\mb{q}, q)}{(\mb{q}_l, \zeroq)}{(\mb{q}_r, q)}}
%     \\
%   \prftree[r]{\rle{skip}}
%     {\qwk{\Gamma}{\mb{q}}{\mb{q}_l}{\mb{q}_r}}
%     {0 \leq q \sqcap \alquant(A)}
%     {\qwk{\Gamma, x : A}{(\mb{q}, q)}{(\mb{q}_l, 0)}{(\mb{q}_r, 0)}}
% \end{gather*}

\begin{equation*}
  \alquant(\cdot) = \topq \qquad
  \alquant(\Gamma^{\mb{q}}, x : A^q) = \alquant(\Gamma^{\mb{q}}) \sqcap \begin{cases}
...
\begin{gather*}
  ...
  \prftree[r]{\rle{zero}}
    ...
    % {\hasty{\Gamma^{\mb{q}'}_{\mb{e}'}}{\epsilon}{a}{A}}
    {\issubst{\Gamma}{\sigma, x \mapsto a}{\Delta, x : A^0_\epsilon}}
  \\
  \prftree[r]{\rle{cons}}
    {\qsp{\Gamma}{\mb{q}}{\mb{q}_l}{\mb{q}_r}}
    {\issubst{\Gamma^{\mb{q_l}}_{\mb{e}}}{\sigma}{\Delta}}
    {\hasty{\Gamma^{\mb{q}_r}_{\mb{e}}}{\epsilon}{a}{A}}
    {q \leq \alquant(\Gamma^{\mb{q}_r})}
    {\issubst{\Gamma}{\sigma, x \mapsto a}{\Delta, x : A^q_\epsilon}}
\end{gather*}
...
\begin{gather*}
  \prftree[r]{\rle{let$_1$-$\beta^+$}}
    ...
    {+ \in \epsilon \parallel \eta}
    {q \leq \alquant(\Gamma^{\mb{q}_r}) \sqcap \alquant^+(\epsilon)}
    {
      \tmle{\Gamma^{\mb{q}}_{\mb{e}}}{\mc{R}}{\letexpr{x}{a}{b}}{[x/a]b}{B}
    }
  \\
  \prftree[r]{\rle{let$_1$-$\beta^+$}}
    {\qsp{\Gamma}{\mb{q}}{\mb{q}_l}{\mb{q}_r}}
    ...
    {q \leq \alquant(\Gamma^{\mb{q}_r}) \sqcap \alquant^-(\epsilon)}
    {
      \tmle{\Gamma^{\mb{q}}_{\mb{e}}}{\mc{R}}{[x/a]b}{\letexpr{x}{a}{b}}{B}
    }
\end{gather*}
...
\begin{gather*}
  \prftree[r]{\rle{nil}}{\cwk{\Gamma^{\mb{q}}_{\ms{e}}}{\cdot}}
                             {\csubst{\Gamma^{\mb{q}}_{\ms{e}}}{\cdot}{\cdot}{E}{p}} \qquad
  \prftree[r]{\rle{zero}}
    {\csubst{\Gamma^{\mb{q}}_{\mb{e}}}{\sigma}{\Delta}{E}{p}}
    % {\hasty{\Gamma^{\mb{q}'}_{\mb{e}'}}{\epsilon}{a}{A}}
    {\csubst{\Gamma}{\sigma, x \mapsto a}{\Delta, x : A^0_\epsilon}{E}{p}}
  \\
  \prftree[r]{\rle{cons}}
    {\qsp{\Gamma}{\mb{q}}{\mb{q}_l}{\mb{q}_r}}
    {\csubst{\Gamma^{\mb{q_l}}_{\mb{e}}}{\sigma}{\Delta}{\eta}{p}}
    {\hasty{\Gamma^{\mb{q}_r}_{\mb{e}}}{\epsilon}{a}{A}}
    {\hasty{\Gamma^{\mb{q}_r}_{\bot}}{\zeta}{a}{A}}
    {p \in \zeta \parallel \eta}
    {q \leq \alquant(\Gamma^{\mb{q}_r}) \sqcap \alquant^p(\zeta)}
    {\csubst{\Gamma^{\mb{q}}_{\mb{e}}}{\sigma, x \mapsto a}{\Delta, x : A^q_\epsilon}{\eta}{p}}
\end{gather*}
...
\begin{theorem}[name=Soundness, restate=soundnessmon]
...
\begin{theorem}[name=Completeness, restate=completenessmon]
  We have that
  $$
  \tmle{\Gamma^{\mb{q}}_{\mb{e}}}{\mc{R}}{a}{b}{A}
...
\TODO{fix a mapping $\dnt{\cdot}$ for base types and functions...}

\TODO{every non-ordered model via the discrete order, \citet{ghalayini-24-ssa-densem-arxiv}}

\TODO{every symmetric premonoidal category}

\TODO{in particular, every Freyd category, garbage-share category, and Markov category}

\TODO{in particular, every strong monad on an SMC}

\TODO{let's do the Option monad...}

\TODO{which becomes the UB monad WithTop when ordered}

\TODO{let's add a heap state transformer, and a printing trace transformer}

\TODO{can also pick more exotic models: the coproduct, for example}

\TODO{to demonstrate linearity, let's build a very simple separation logic model}

\TODO{more interesting: the category of concurrent games, \citet{vale-linearizability-24}, which
has a cool refinement structure, too!}

\TODO{another fun linear model for quantum computing: Hilbert spaces}

\TODO{can we do quantum refinement???}
...
\begin{gather*}
  \prftree[r]{\rle{inl}}{f : A \to B}
    {\hasty{\Gamma^{\mb{q}}_{\mb{e}}}{\epsilon}{a}{A}}
    {\hasty{\Gamma^{\mb{q}}_{\mb{e}}}{\epsilon}{\linl{a}}{A + B}} \qquad
  \prftree[r]{\rle{inr}}{f : A \to B}
...
\TODO{every distributive premonoidal category}

\TODO{in particular, every Freyd category, garbage-share category, and Markov category w/ the
appropriate niceness}

\TODO{in particular, every strong monad on a distributive SMC}

\TODO{previous examples work without changes: UB, heap, separation logic, and quantum}
