...
\begin{figure}
  \begin{gather*}
    ...
    \\
    \boxed{\dwnqv{\ms{L}^{\mb{Q}}}_{\Gamma}
      : \mc{C}_\bot(
          \dnt{\ms{L}^{\zeroqv{\mb{Q}}}}(\Gamma, x : A), 
          \dnt{\ms{L}^{\mb{Q}}}(\Gamma)
        )}
    \\
    \dwnqv{\cdot}_\Gamma = \ms{id}_{\mb{0}} \qquad
    \dwnqv{\ms{L}^{\mb{Q}}, \lhyp{\ell}{A}^{\mb{q}}_{\epsilon}}_\Gamma
    = \dwnqv{\ms{L}^{\mb{Q}}}_\Gamma + \rho_{\dnt{\Gamma^{\mb{q}}}} \otimes \dnt{A}
    \\
