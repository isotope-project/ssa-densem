...
Their syntax sticks very closely to LLVM, and so their operational semantics must compute
$\phi$-nodes at each step, and furthermore they give several such semantics and
prove refinements between them. Each operational semantics is further parameterized
...
\noindent \textbf{Effect Systems and Linearity} \todo{Ohad, lipton, fuhrmann, plotkin-power, etc}
