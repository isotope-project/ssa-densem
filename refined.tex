...
We need weakening and context splitting judgements to formulate the rules of the type system.
We can begin by defining weakening $\cwk{\Gamma^{\mb{q}}}{\Delta^{\mb{q}'}}$ of contexts as follows:
\begin{gather*}
