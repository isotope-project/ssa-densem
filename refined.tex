...
\begin{figure}
  ...
  \begin{gather*}
    \prftree[r]{\rle{unif$^p$}}
      ...
      {\tmlep{\Gamma^{\mb{q}_c}, x : A}{\mc{R}}
        {\letexpr{y}{s}{b}}
        {\caseexpr{b'}{z}{\linl{c}}{x}{\linr{s}}}{B + S}{p}}
      {
        \tmlep{\Gamma^{\mb{q}}}
          {\mc{R}}
          {\letexpr{x}{a}{\liter{s}{y}{b}}}
    ...
    \qquad {\hasty{\Gamma^{\mb{q}_m}, z : B}{}{c}{C}}
  \end{gather*} 
  \end{adjustbox}
...
\begin{itemize}
  ...
  \begin{align*}
    ...
    \\
    &= ... \\
    &= (\lambda (x, y) . \liter{y}{z}{\caseexpr{a}{w_l}{\linl{(x, w_l)}}{w_r}{\linr{w_r}}}) \\
    &= (\lambda (x, y) . \letexpr{u}{\liter{y}{z}{a}}{(x, u)}) \\
