...
\end{gather*}
It is easy to see that this induces a partial order on annotated contexts. We can then go on to
define context splitting $\qsp{\Gamma}{\mb{q}}{\mb{q}_l}{\mb{q}_r}$ as follows:
\begin{gather*}
  \prftree[r]{\rle{nil}}
