    ...
    & = \dnt{\qsp{\Gamma}{\mb{q}}{\mb{q}_{123}}{\mb{q}_4}} 
      ...
      ; \delta^{-1} ;[ \\ & \qquad
          ...
          ; (\dnt{\Gamma^{\mb{q}_{12}}} \otimes I) 
              \otimes \dnt{\hasty{\Gamma^{\mb{q}_3}, y : A}{\epsilon}{P}{D}}
          ; \iota_r
          ; \alpha^\downarrow, \\ & \qquad
          \dnt{\qsp{\Gamma, z : B}{\mb{q}_{123}, \omega}{\mb{q}_{12}, 0}{\mb{q}_3, \omega}}
          ; (\dnt{\Gamma^{\mb{q}_{12}}} \otimes I) 
              \otimes \dnt{\hasty{\Gamma^{\mb{q}_3}, z : B}{\epsilon}{Q}{D}}
          ; \iota_r
          ; \alpha^\downarrow
      \\ & \quad
      ];[
      ...
      &= ... \text{\todo{handle the down-associators, pull back the splits, and kill injections}} \\
      &= ... \text{\todo{de-distribute the splits}} \\
      &= ... \text{\todo{re-associate}} \\
      &= ... \text{\todo{finish this, ELAS -- GitHub Copilot}}
  \end{align*}
