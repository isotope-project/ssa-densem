...
\begin{definition}[\subiterssa-signature morphism]
  ...
  \end{itemize}
  We say that a morphism $T$
  \begin{itemize}
    \item $T$ is \emph{strict} if, for all effects $\epsilon, \eta$, we have $\alquant{\epsilon}
    \leq \alquant{T\;\epsilon}$; this property holds for the identity and is preserved by
    composition, and therefore forms a wide subcategory.
...
\begin{definition}[Conway Iteration Operator]
  \;\TODO{this}
  \;\TODO{enrichment}
  \;\TODO{\emph{enriched} uniformity}
  \;\TODO{strength}
\end{definition}

\begin{definition}[Elgot effectful category]
  \;\TODO{this}
\end{definition}
...
\begin{definition}[\subiterssa-model morphism]
  ...
  \begin{itemize}
    ...
    \item $F: \mc{C} \to \mc{C}'$ is a strict symmetric monoidal functor
