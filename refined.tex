...
$\dnt{\ltoty{\Gamma}{\ell(A)^{\mb{0}}}} = \mb{0} + \dnt{\Gamma^{\mb{0}}} \otimes \dnt{A}$. As this
transformation is complicated to state and verify for general expressions, we will instead define
\emph{ANF}, and, after showing how every expression can be compiled to an equivalent expression in
ANF, define $\ms{SSA}_\ell$ by induction over such expressions.
...
\begin{itemize}
  ...
  \begin{align*}
    ...
    & = \dnt{\hasty{\Gamma^{\mb{q}}}{\epsilon}{o}{A}} 
      ...
      ; \iota_r
  \end{align*}
  \item ($\hasty{\Gamma^{\mb{q}}}{\epsilon}{\letexpr{x}{o}{P}}{A}$): we define
  $(\tossa{\ell}{\letexpr{x}{o}{P}}) := \letstmt{x}{o}{\tossa{\ell}{P}}$, which is trivially correct
  by induction.
  \item ($\hasty{\Gamma^{\mb{q}}}{\epsilon}{\letexpr{(x, y)}{o}{P}}{A}$): we define
  $(\tossa{\ell}{\letexpr{(x, y)}{o}{P}}) := \letstmt{(x, y)}{o}{\tossa{\ell}{P}}$, which is
  trivially correct by induction.
  \item ($\hasty{\Gamma^{\mb{q}}}{\epsilon}{\letexpr{x}{\caseexpr{o}{y}{P}{z}{Q}}{R}}{C}$): we
  define
  \begin{align*}
  ...
  \end{align*}
  \TODO{in the burning heart of the moment, I can't figure out how to write this -- GitHub Copilot}
  \item ($\hasty{\Gamma^{\mb{q}}}{\epsilon}{\letexpr{x}{\liter{o}{x}{P}}{Q}}{B}$): 
  \begin{align*}
