...
\subiterexp{} is, at first glance, a standard first-order expression language with branching and
iteration; in short, a functional analogue of \textsc{While}. We present its grammar in
Figure~\ref{fig:expr-syntax}; this is parametrized by a set of \emph{base types} $X \in \mc{X}$ and
