...
\TODO{fuse these trains of thought, or re-order}

\emph{Soundness} w.r.t. equivalence is easy enough to state: we want, given
$\tmeq{\Gamma^{\mb{q}}}{\mc{R}}{a}{b}{A}$, $\dnt{\hasty{\Gamma^{\mb{q}}}{\epsilon}{a}{A}} =
\dnt{\hasty{\Gamma^{\mb{q}}}{\epsilon}{b}{A}}$. However, we would also like to interpret our
refinement relation $\tref$. To do so, we will generalize our setting slightly to consider
...
\begin{definition}[Symmetric Premonoidal Category]
  ...
  \otimes f : B \otimes A \to B' \otimes A'$ respectively.
...
\begin{definition}[Conway Iteration Operator]
  ...
  \end{itemize}
\end{definition}
We'd like our Conway iteration operator to play nicely with our premonoidal structure; in
particular, we require our Conway iteration operator to be \emph{strong}, defined as follows:
