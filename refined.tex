...
We define the syntactic category of \subiterexp{}-models of a signature $\mc{S} = (\mc{X}, \mc{E},
\mc{I})$ quotiented by a set of primitive rewrites $\mc{R}$ as follows:
\begin{itemize}
  ...
  \item Tensor products (with the tensor product on objects simply the tensor product on types)
  $$
  ...
  \end{gather*}
  \item \todo{coproducts and initial object}
  \item \todo{distributors}
  \item \todo{iteration operator}
  \item \todo{discard and duplicate}
\end{itemize}
...
\TODO{this, and in particular translation functors}

\subsection{Packing Lemma}

\label{apx:packing}

\TODO{permutation lore}
