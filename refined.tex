...
\end{equation*}
We want our refinement relation to contain $\mc{R}$; furthermore, we want it to induce a partial
order on terms in context. We hence postulate the following rules:
\begin{gather*}
  \prftree[r]{\rle{base}}
...
\end{gather*}
Note in particular that this allows us to define equivalence of terms as follows:
\begin{equation*}
  \tmeq{\Gamma^{\mb{q}}}{\mc{R}}{a}{b}{A}
  \iff \tmle{\Gamma^{\mb{q}}}{\mc{R}}{a}{b}{A} 
  \land \tmle{\Gamma^{\mb{q}}}{\mc{R}}{b}{a}{A}
\end{equation*}
We would also like our refinement relation to be a \emph{congruence} w.r.t. our term formers, which
we achieve using the following rules:
\begin{gather*}
  \prftree[r]{\rle{var}}
