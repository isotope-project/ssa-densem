...
all other elements incomparable. We give a full description of this monad and its associated Elgot
...
$$
We note that we can soundly take...
...
This structure plays nicely with the state transformer, allowing
us to define, for arbitrary state $S$, $\ms{SUB}\;S\;A = S \to \ms{UB}\;(A \times S)$, with the natural
