...
The final rule we need to cover is the rule \brle{uni}, which expresses that the \ms{where}-block
construction is \emph{uniform} with respect to pure substitutions.
