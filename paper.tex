...
\TODO{thankfully, the solution is not particularly difficult; rather than have variables $x$, we
just have pure expressions $a$}

\TODO{while we're at it, we can build up a proper expression language with let-bindings and
conditionals...}

% NOTE: things would be a _lot_ nicer if our expression language had iteration, too; but this
% changes our results and narrative. Try doing this in a branch...

\TODO{it is in fact sometimes useful to discuss general expressions $e$}
