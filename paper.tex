...
about SSA itself, as we explore in this paper. Two papers which exemplify this approach are
\citet{benton-kennedy-99} and \citet{garbuzov-structural-cfg-2018}.
...
\TODO{we can add structure to traces, and quotient}

\TODO{or we can do games, which can be modified to represent... True Concurrency}

\TODO{so we can do truly concurrent structures like pomsets}

\TODO{and event structures}
