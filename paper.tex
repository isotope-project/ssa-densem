...
the rules given in Figure \ref{fig:ssa-reg-rules}. In particular,
\begin{itemize}
...
demonstrate this, we will show how to build a simple model of TSO weak memory based on that given in
\citet{sparky}.
...
a_3, ...$, we would like to model concurrency by considering a \emph{partially ordered multiset}, or
