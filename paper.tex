...
(\url{https://github.com/imbrem/debruijn-ssa}), weighs about \~29k LoC. Each formalized theorem is
tagged as such in the respective proof. It was also necessary to fork Mathlib's monoidal category
implementation to support Freyd categories, distributivity, and Elgot structure: the resulting
library, \texttt{discretion} (\url{https://github.com/imbrem/discretion}), weighs about \~27k LoC.
We are currently trying to upstream support for premonoidal categories into Mathlib.
