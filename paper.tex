...
\begin{itemize}
  ...
  \item $\isssa{r}$ means that the region $r$ is a lexical SSA region. 
        We note that $\isssa{r} \implies \toanf{r}$.
...
We would now like to define a syntactic transformation from regions $r$ to equivalent lexical SSA
regions $\tossa{r}$. To do this, we begin by giving a syntactic transformation $\ssawhere{r}{L}$
from ANF regions $r$ \emph{targeting} labels in $L$ to syntactically equivalent lexical SSA
regions:
\begin{equation}
  \begin{aligned}
