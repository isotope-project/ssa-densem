...
\TODO{insert figure for table of judgements and metatheoretic judgements?}
...
\begin{theorem}[Completeness (Terms)]
  ...
  \end{itemize}
  quotiented by (...) is a distributive Freyd category,
  with:
  \begin{itemize}
    \item Pure morphisms $\ms{Th}^\otimes_\bot(\Gamma)(A, B)$
...
\begin{theorem}[Completeness (Regions)]
  ...
  \begin{itemize}
    ...
    \item Morphisms $\ms{Th}(\Gamma, \ms{L})(A, B) 
      = \{r \mid \haslb{\Gamma, \bhyp{\square}{A}}{r}{\ms{L}, \ms{ret}(B)}\}$
  ...
  \end{itemize}
  quotiented by (...) is a distributive Freyd category with:
  \begin{itemize}
    \item Pure morphisms: ...
    \item Tensor functors: ...
    \item Projections: ...
  ...
  \end{itemize}
  where we write $\ms{ret}\;e = \ms{br}\;\ms{ret}\;e$. Furthermore,
  \begin{enumerate}
