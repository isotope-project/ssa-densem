...
We may group our rules according to the relevant constructor, i.e.
$\ms{let}$ (unary and binary) and $\ms{case}$. In particular, for unary $\ms{let}$, we have the
following rules, summarized in Figure~\ref{fig:ssa-unary-let-expr}:
\begin{itemize}
...
\begin{figure}
  ...
  \end{gather*}
  \Description{}
  \caption{Rules for \isotopessa unary \ms{let}-statements}
\end{figure}
...
\begin{figure}
  ...
  \end{gather*}
  \Description{}
  \caption{Rules for \isotopessa binary \ms{let}-statements}
\end{figure}
...
\begin{figure}
  \begin{gather*}
    ...
    % TODO: check if these can actually be removed!
    % \\
    ...
    %     }
    %     {
    %       \hspace{1.3em} \teqv \ms{let}\;x = a; \ms{case}\;x\;\{
  ...
  \end{gather*}
  \Description{}
  \caption{Rules for \isotopessa \ms{case}-statements}
\end{figure}

\TODO{basic where theory}
...
\begin{figure}
  \begin{gather*}
      ...
      \prftree[r]{\rle{cfg-cfg}}
        ...
        }
        {
          ...
          {\teqv \where{r}{(\wbranch{\kappa_i}{x_i}{s_i},)_i(\wbranch{\ell_i}{y_j}{t_j},)_j} 
            : \ms{L}}
        }
      \\
  ...
  \end{gather*}
  \Description{}
  \caption{Rules for \isotopessa \ms{where}-statements}
\end{figure}
