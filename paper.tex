...
\begin{itemize}
  ...
  $\casestmt{o}{y}{\tau}{z}{\tau'}$ on a Boolean value $o : \mb{1} + \mb{1}$. This is equivalent in
  power to regular conditional branches, while allowing our work to generalize easily to
  higher-level settings as well.
...
\begin{figure}[H]
  \begin{center}
    \begin{grammar}
      ...
      <\(\tau\)> ::= \(\ms{br}\;\ell\) \;|\; $\casestmt{o}{y}{\tau}{z}{\tau'}$
