...
\item We also show, in Section~\ref{ssec:completeness}, that syntax quotiented by the equational
  ...
  \TODO{using completeness, we can freely mix equational reasoning and semantic reasoning, depending
  on what is convenient for the product at hand.}

  \TODO{completeness also makes it easy to use categorical methods to treat \emph{other} syntaxes,
  like $\lambda_{\ms{iter}}$, but we probably can't fit that in this narrative}
