...
\TODO{make sure upgrade is defined both on the left and the right; \emph{or} do this separately}
...
\begin{proof}
  ...
  \begin{itemize}[leftmargin=*]
    ...
    \begin{equation}
      \begin{aligned}
        & \entrymor{\Gamma}{[\upg{\sigma}]s}{\ms{K}} 
    ...
    \begin{equation}
      \begin{aligned}       
        & \loopmor{\Gamma}{(\wbranch{\ell_i}{x_i}{[\upg{\sigma}]t_i},)_i}{\ms{K}} 
          = \delta^{-1}_{\Sigma} 
    ...
    \begin{equation}
      \begin{aligned}
        & \rcase{\loopmor{\Gamma}{(\wbranch{\ell_i}{x_i}{[\upg{\sigma}]t_i},)_i}{\ms{K}}} \\
        & = \lmor{
            \lmor{L} 
    ...
    \begin{equation}
      \begin{aligned}
        \rfix{\loopmor{\Gamma}{(\wbranch{\ell_i}{x_i}{[\upg{\sigma}]t_i},)_i}{\ms{K}}}
        & = (\rcase{L}
        ; \dmor{\dnt{\Gamma}} \otimes \dnt{\ms{L}} ; \alpha ; \dnt{\Gamma} \otimes S
    ...
    \begin{equation}
      \begin{aligned}
        ...
        & = \lmor{\entrymor{\Gamma}{[\upg{\sigma}]s}{\ms{K}}} ; \delta^{-1} 
          ; [\pi_r , \rfix{\loopmor{\Gamma}{(\wbranch{\ell_i}{x_i}{[\upg{\sigma}]t_i},)_i}{\ms{K}}}] \\
...
\begin{proof}
  ...
  \begin{itemize}[leftmargin=*]
    ...
    \begin{equation}
      \begin{aligned}
        & \entrymor{\Gamma}{[\upg{\sigma}]r}{\ms{L}}
    ...
    \begin{equation}
      \begin{aligned}
        & \dnt{\haslb{\Gamma}
          {\where{[\upg{\sigma}]r}{(\wbranch{\kappa_i}{x_i}{[\upg{\sigma}]t_i},)_i}}
          {\ms{L}}} \\
        & = \lmor{\entrymor{\Gamma}{[\upg{\sigma}]r}{\ms{L}}} ; \delta^{-1} ; [\pi_r,
          \rfix{\loopmor{\Gamma}{(\wbranch{\kappa_i}{x_i}{[\upg{\sigma}]t_i},)_i}{\ms{L}}}] \\
        ...
        ; [
          ...
          \rfix{
            \loopmor{\Gamma}{(\wbranch{\ell_i}{x_i}
                    {[\upg{(\kappa_j(x_j) \mapsto t_j,)}](\sigma_i\;x_i)},)_i}{\ms{L}}}
        ] \\
        & = \dnt{\haslb{\Gamma}
