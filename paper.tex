...
\begin{figure}
  ...
  \begin{align*}
    ...
    \dnt{\haslb{\Gamma}{\where{r}{(\wbranch{\ell_i}{x_i}{t_i},)_i}}{\ms{L}}}
      ...
      \\ & \quad \dnt{\Gamma} \otimes \alpha^+_{\dnt{L} + \Sigma_i \dnt{A_i}} 
      ; \delta^{-1} )^\dagger ; \pi_r ]
  \end{align*} 
  \begin{equation*}
    \text{where} \quad \boxed{\iota_{\ms{L}, \ell} : \dnt{A} \to_\bot \dnt{\ms{L}}} \qquad
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \end{equation}
    as desired.
    \item If $r = (\letstmt{x}{a}{t})$, then \todo{this}
    \item If $r = (\letstmt{(x, y)}{a}{t})$, then \todo{this}
    \item If $r = \casestmt{a}{x}{s}{y}{t}$, then \todo{this}
    \item If $r = \where{s}{(\wbranch{\ell_i}{x_i}{t_i},)_i}$, then \todo{this}
  \end{itemize}
