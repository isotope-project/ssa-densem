...
\begin{lemma}[\ms{where}-fusion]
  The rewrite rules given in Equation~\ref{eqn:where-fusion-1} and Equation~\ref{eqn:where-fusion-2}
  are sound.
  \label{lem:where-fusion}
\end{lemma}
\begin{proof}
  We begin with Equation~\ref{eqn:where-fusion-1}. Let %
  ...
  \begin{equation}
    ...
    \end{aligned}
  \end{equation}
  We have by re-association and weakening that
  \begin{equation}
    \begin{aligned}
      D_G 
      & = \alpha^+_{\dnt{\ms{R}} + \dnt{\ms{K}}} ; [
        \delta^{-1}_\Sigma ; [
    ...
    \end{aligned}
  \end{equation}
  where $C_{1..k} = A_{1..k}$ and $C_{k+1..n} = B_{1..n-k}$. We have that
\end{proof}
