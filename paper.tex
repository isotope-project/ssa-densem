...
$
on terms $a, a'$ for each context $\Gamma$, effect $\epsilon$, and type $A$.
This will be presented as a set of simple \emph{rewriting rules} along with a
\emph{congruence}, which is given in Figure~\ref{fig:ssa-expr-congr-rules}.
