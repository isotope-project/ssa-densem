...
\begin{itemize}
  ...
  \item Guarded effect handlers via guarded Elgot monads; closest to our work, even more than MIL
  \cite{goncharov-metalang-21}, based on labelled-iteration from \citet{geron-iteration-16}
