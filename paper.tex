...
is essentially replacing ``variables from $\Gamma$'' with ``variables from $\Delta$.'' Since none of
...
$\Gamma$ with \emph{different} variables in $\Delta$ of the same type, or, more generally, arbitrary
...
type-check. An assignment of such variables $\gamma : x \mapsto \gamma_x$ is called a
