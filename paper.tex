...
\textit{labels} $\lhyp{\ell}{A}$, where $A$ is the parameter type that must be passed on a jump to
...
\TODO{what is a region; connection to SSA lore, rework below list to fit into
narrative}
...
\begin{figure}
  \begin{gather*}
    ...
    \\ \\
    [\sigma](\brb{\ell}{a}) = \brb{\sigma(\ell)}{a} \qquad
