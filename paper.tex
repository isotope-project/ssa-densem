...
\begin{itemize}
  ...
  \begin{equation}
    ...
    & = \dmor{R} ; \alpha 
      ; R \otimes (\alpha^{-1} ; R \otimes \sigma ; \alpha^{-1} ; f \otimes \mb{1} ; \sigma) 
      ; \pi_r ; \pi_r \\
    & = R \otimes \pi_r ; f \\
  ...
  $\rseq{}{g}{\rho^R} = g ; \pi_r$.
  \item $\sigma^R_{A, B}$ is natural: given $f : R \otimes A \to A'$,
  \TODO{equation}
  \TODO{diagram}
  \TODO{other case is analogous}
...
\TODO{pull down $\rfix{f}$ lore here?}
...
\TODO{pull lemma into previous section, somehow?}
