...
claims:
\begin{enumerate}
  \item Every \isotopessa{} region can be converted to an equivalent lexical SSA region in linear
  space
...
\end{itemize}
We can define a linear-space syntactic function to convert an \isotopessa{} region to ANF
...
\begin{equation}
  \begin{aligned}
    ...
    \letanf{x}{\caseexpr{e}{y}{a}{z}{b}}{r} &= 
      \where{\letanf{w}{e}{\casestmt{w \\ & \qquad}
            {y}{\letanf{x}{a}{\brb{\ell}{x}}}{z}{\letanf{x}{b}{\brb{\ell}{x}}}} \\ & \qquad}
            {\wbranch{\ell}{x}{r}} \\
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \begin{equation}
      ...
      \end{aligned}
    \end{equation}
    The proof for \ms{case}-statements is analogous, except that we also apply label-substituion to
    the right-hand side.
