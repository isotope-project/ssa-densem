...
\begin{enumerate}
  \item We recall classical SSA form, and recall that it is equivalent to the basic  blocks with arguments format. 
  ...
  \item We formalize these intuitions by giving algorithms to translate back and forth between functional SSA 
    and \isotopessa{}.  Furthermore, in section~\ref{?} we show that this translation is fully 
...
\TODO{handle rewriting note here}
