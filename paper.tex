...
\begin{proof}
  We begin by showing \ref{itm:varwk} (i.e., that variable weakenings compose), by the following
  simple induction:
  \TODO{this}
  We can analogously show \ref{itm:lbwk} (i.e., that label weakenings compose), as follows:
  \TODO{this}
  We show weakening for expressions $\hasty{\Gamma}{\epsilon}{a}{A}$ \ref{itm:expwk} by induction
  on the typing derivation:
  \TODO{this}
  Similarly, we can show weakening for regions $\haslb{\Gamma}{r}{\ms{L}}$ \ref{itm:lbwk} by
