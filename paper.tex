...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \end{equation}
    as desired.
    \item If $e = f\;a$ is an operation, then
    \TODO{this}
    The cases for left injections, right injections, and \ms{abort} are analogous
    \item If $e = \letexpr{x}{a}{b}$ is a unary \ms{let}-binding, then \todo{this}
