...
\begin{figure}
  \begin{gather*}
    ...
    \prftree[r]{\rle{sb-cons}}{\issubst{\gamma}{\Gamma}{\Delta}}{\hasty{\Gamma}{\epsilon}{e}{A}}
      {\issubst{\gamma, x \mapsto e}{\Gamma}{\Delta, \thyp{x}{A}{\epsilon}}} \qquad
...
\begin{itemize}
  \item \brle{sb-nil} says that the empty substitution takes the empty context to the empty context.
  ...
  unwieldy operators. In particular, this implies that the empty substitution always acts as the
