...
\begin{equation}
  ...
  \lmor{\rfix{f}} ; \pi_l \otimes B 
    &= \dmor{} ; \pi_l \otimes (R \otimes A) ; R \otimes ((\rcase{f})^\dagger ; \pi_r) \\
    &= \dmor{} ; \pi_l \otimes (R \otimes A) 
      ; (R \otimes \rcase{f} ; \delta^{-1} ; R \otimes \pi_r + R \otimes B)^\dagger \\
    &= (\rcase{f})^\dagger
  \end{aligned}
\end{equation}
by uniformity, since
\begin{equation}
  \begin{aligned}
    & \dmor{} 
      ; \pi_l \otimes (R \otimes A) 
      ; R \otimes \rcase{f} 
      ; \delta^{-1} 
      ; R \otimes \pi_r + R \otimes B \\
    & = \dmor{} 
    ; \pi_l \otimes (R \otimes A) 
    ...
    \begin{equation}
      \begin{aligned}
        ...
        & = \lmor{\lmor{\entrymor{s}}} ; \dnt{\Gamma} \otimes (\delta^{-1} ; S + \pi_r)
          ; \delta^{-1}
          ; [\pi_r, (\rcase{L})^\dagger ; S] \\
        & = \lmor{\entrymor{s}} ; \dmor{\Gamma} \otimes (\dnt{\ms{L}} + \Sigma_i\dnt{A_i}) ; \alpha 
          ; \dnt{\Gamma} \otimes \delta^{-1}
          ; \delta^{-1}
          ; [\dnt{\Gamma} \otimes S ; \pi_r, \dnt{\Gamma} \otimes \pi_r ; (\rcase{L})^\dagger ; S] 
          \\
        & = \lmor{\entrymor{s}} ; \dmor{\Gamma} \otimes (\dnt{\ms{L}} + \Sigma_i\dnt{A_i}) ; \alpha 
          ; \dnt{\Gamma} \otimes \delta^{-1}
          ; \delta^{-1}
        ...
        & = \lmor{\entrymor{s}} ; \delta^{-1} ; [
          ...
          ; S \\
        & = \lmor{\entrymor{s}} ; \delta^{-1} ; [
            \ms{id}_{\dnt{\Gamma} \otimes \dnt{\ms{L}}}, 
            \Delta_{\dnt{\Gamma}} \otimes \Sigma_i\dnt{A_i}  
              ; \alpha ; (\dnt{\Gamma} \otimes (\rcase{L})^\dagger) ; \pi_r)]
          ; S \\
        & = \text{\todo{why?}} \\ 
        & = \lmor{\lmor{\entrymor{s}} ; \delta^{-1} ; [
            \ms{id}_{\dnt{\Gamma} \otimes \dnt{\ms{L}}}, 
            (\rcase{L})^\dagger] ; \pi_r}
          ; S \\
        & = \lmor{\lmor{\entrymor{s}} ; \delta^{-1} ; [
