...
\newcommand{\anfssa}[1]{\ms{SSA}(#1)}
\newcommand{\ssawhere}[2]{\ms{SSA}(#1, #2)}
...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
\TODO{correctness theorem}

\TODO{proof? or do we segue to densem-based proof?}
