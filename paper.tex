...
which purely encode data, with no particular instructions on how to use it afterwards.
Similarly,
\begin{itemize}
  \item We interpret \todo{letting a variable}
  \item \todo{letting a pair}
  \item \todo{case-expressions}
\end{itemize}
\TODO{semantics of \ms{where}-blocks}
