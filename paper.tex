...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \begin{equation}
      ...
      ; \dnt{\hasty{\Delta, \bhyp{x}{A}}{\epsilon}{b}{B}}
      \\ &= \dnt{\hasty{\Delta, \bhyp{x}{A}}{\epsilon}{[\gamma, x \mapsto x]b}{B}}
          = \dnt{\hasty{\Gamma}{\epsilon}{[\gamma]b}{B}}
      \end{aligned}
    \end{equation}
    ...
    \begin{equation}
      ...
      \end{aligned}
    \end{equation}
    \item If $e = (\letexpr{(x, y)}{a}{b})$ is a binary \ms{let}-binding, then \todo{this}
    \item If $e = \caseexpr{a}{x}{b}{y}{c}$ is a \ms{case}-expression, then \todo{this}
  ...
  \end{itemize}
  Substitution for substitutions and label substitutions then follow by a trivial induction.
\end{proof}
