...
pure/constant; for example, \citet{release-acquire} note that, since they use a monadic semantics,
they have access to a huge amount of generic machinery to deal with, e.g., higher-order programs,
``for free''. In particular, we observe that we often only require information about:
\begin{enumerate}
